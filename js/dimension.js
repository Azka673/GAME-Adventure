...
const Dimension = (() => {
  ...
  const DIM_DATA = {
    ...
    3: {
      ...
      intro: [
        ...
        "Langit berawan, vegetasi rimbun, dan suara gemuruh hewan raksasa di kejauhan.",
        "Di sini, predator dan mangsa hidup berdampingan dalam keseimbangan yang keras.",
        "Jawab pertanyaan rahasia ini untuk mendapatkan pengetahuan Mesozoikum!",
      ],
      ...
      quizAns: 1,
      quizFact: "Mesozoikum dikenal sebagai era dinosaurus. Pada masa ini, banyak predator besar muncul, tetapi juga sawah dan hutan tropis yang lebat.",
    ...
    4: {
      ...
      intro: [
        ...
        "Di sini, perunggu dan besi membawa perubahan besar pada senjata dan alat.",
        "Jawab pertanyaan rahasia ini untuk mendapatkan pengetahuan Perundagian!",
      ],
      quizQ: "Apa bahan utama yang mulai digunakan manusia pada Zaman Perundagian?",
      quizOpts: ["Kayu", "Batu", "Logam seperti besi dan perunggu", "Tulang hewan"],
      quizAns: 2,
      quizFact: "Zaman Perundagian menandai penggunaan logam: pembuatan senjata, alat tani, dan perhiasan mulai berkembang pesat.",
  ...
  function enter(dimId) {
    ...
    // Cek apakah sudah pernah masuk dimensi ini
