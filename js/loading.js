// ===== LOADING.JS =====
// Layar muat: judul game di atas + bar progres + sambutan per huruf (Typewriter di utils.js)
...
const LoadingScreen = (() => {
  ...
  function _mountHTML() {
    ...
    el.innerHTML = `
      ...
      <button id="loadSkip" onclick="LoadingScreen._skip()">Lewati</button>
    `;
  ...
  function _runProgress() {
    ...
    progressTimer = setTimeout(_runProgress, delay);
  }
    ...
    Typewriter.write(el, text, {
      ...
      onDone: () => {
        ...
        welcomeTimer = setTimeout(() => {
          el.textContent = '';
          welcomeTimer = setTimeout(_runWelcomeLines, 200);
        }, 900);
      },
    });
  }
