...
const Crafting = (() => {
  ...
  const RECIPES = [
    ...
    {
      output: { e: '🧥', n: 'Baju Kulit', c: 1 },
      emoji: '🧥',
      name: 'Baju Kulit',
      desc: 'Baju perlindungan dari kulit hewan. Mengurangi 20% damage dari musuh.',
      ingredients: [
        { e: '🍖', n: 'Daging', c: 5 },
        { e: '🪵', n: 'Kayu', c: 3 },
      ]
    ...
    {
      output: { e: '🪨', n: 'Mantel Batu Megalitikum', c: 1 },
      emoji: '🪨',
      name: 'Mantel Batu Megalitikum',
      desc: 'Mantel batu tebal dari era Megalitikum. Mengurangi 25% damage dari musuh. Perlindungan terbaik!',
      ingredients: [
        { e: '🪨', n: 'Batu', c: 8 },
        { e: '🪵', n: 'Kayu', c: 4 },
      ]
    ...
    {
      output: { e: '⚒️', n: 'Pedang Besi', c: 1 },
      emoji: '⚒️',
      name: 'Pedang Besi',
      desc: 'Senjata era Perundagian dari besi murni. Damage lebih tinggi dari pedang bronze.',
      ingredients: [
        { e: '⛏', n: 'Besi', c: 8 },
        { e: '🪵', n: 'Kayu', c: 3 },
      ]
    ...
    {
      output: { e: '🛡️', n: 'Perisai Besi', c: 1 },
      emoji: '🛡️',
      name: 'Perisai Besi',
      desc: 'Perisai dari besi berkualitas. Durability lebih tinggi dan block chance lebih besar.',
      ingredients: [
        { e: '⛏', n: 'Besi', c: 10 },
        { e: '🪵', n: 'Kayu', c: 2 },
      ]
    ...
    {
      output: { e: '🔔', n: 'Baju Besi', c: 1 },
      emoji: '🔔',
      name: 'Baju Besi',
      desc: 'Armor besi yang memberikan proteksi maksimal. Mengurangi 30% damage dari musuh!',
      ingredients: [
        { e: '⛏', n: 'Besi', c: 12 },
        { e: '🪵', n: 'Kayu', c: 4 },
      ]
