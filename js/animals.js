...
const AnimalSystem = (() => {
  const TYPES = [
    { e:'🦌', n:'Rusa',       spd:0.65, hp:3, mhp:3, drop:{ e:'🍖', n:'Daging' }, r:20, aggressive:false, atk:0 },
    { e:'🐗', n:'Babi Hutan', spd:0.85, hp:5, mhp:5, drop:{ e:'🍖', n:'Daging' }, r:22, aggressive:true,  atk:8 },
    { e:'🐇', n:'Kelinci',    spd:0.90, hp:1, mhp:1, drop:{ e:'🍖', n:'Daging' }, r:12, aggressive:false, atk:0 },
    { e:'🐦', n:'Burung',     spd:0.55, hp:1, mhp:1, drop:null,                  r:10, aggressive:false, atk:0 },
    { e:'🐍', n:'Ular',       spd:0.50, hp:2, mhp:2, drop:null,                  r:14, aggressive:true,  atk:6 },
    { e:'🦊', n:'Rubah',      spd:0.80, hp:2, mhp:2, drop:{ e:'🍖', n:'Daging' }, r:16, aggressive:true,  atk:5 },
    { e:'🦋', n:'Kupu-kupu',  spd:0.40, hp:1, mhp:1, drop:null,                  r:10, aggressive:false, atk:0 },
  ];
  ...
  function update() {
    animals.forEach(a => {
      ...
      if (a.aggressive && a.alerted && pd < 42 && a.atkTimer <= 0) {
        Player.hp = Math.max(0, Player.hp - a.atk);
        World.spawnParticles(Player.x, Player.y, '#ff4444', 6);
        Utils.notify(`${a.n} menyerang balik!`, '#ff5555');
