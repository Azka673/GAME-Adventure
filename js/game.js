...
const GameCore = (() => {
  ...
  function _setupInput() {
    ...
    // Joystick — Pointer Events (mouse + sentuh + pen)
    ...
    jOut.addEventListener('pointerup', joyPointerEnd);
    jOut.addEventListener('pointercancel', joyPointerEnd);
