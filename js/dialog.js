...
const StoryDialogs = {
  ...
  // ---- SECRET KEY DIALOG ----
  secretKey: [
    { speaker: 'Suara Misterius', portrait: '🔑', text: '🔑 Kunci Rahasia... item legendaris yang terlupakan zaman.' },
    { speaker: 'Suara Misterius', portrait: '🔑', text: 'Kunci ini akan membuka portal terakhir di ujung timur laut.' },
    { speaker: 'Suara Misterius', portrait: '🔑', text: '⚠️ Tetapi bersiaplah... apa yang menanti di sana BUKAN PERMAINAN.' },
    { speaker: 'Suara Misterius', portrait: '🔑', text: '🦖 Dragon Proto, makhluk purba paling berbahaya, menjaga ujung dunia.' },
    { speaker: 'Suara Misterius', portrait: '🔑', text: 'PILIHAN TERAKHIRMU, PETUALANG: PULANG ATAU MENJADI SEORANG RAJA?' },
  ],
};
