...
const Player = {
  ...
  speed: 6.5, facing: 0,          // was 3.8 — naik jadi 6.5 (terasa responsif)
  sprintOn: false,
  ...
  update(jDx, jDy, keys) {
    ...
    const spd      = this.speed * (sprinting ? 1.9 : 1); // was 2.6x — sekarang 1.9x terasa natural
    ...
    // Stamina
    if (sprinting) this.stamina = Math.max(0, this.stamina - 0.5);  // was 0.8 — lebih hemat
    else           this.stamina = Math.min(100, this.stamina + 1.2); // was 0.7 — regen lebih cepat
